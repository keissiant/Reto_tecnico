...
public class PaginaDeUltimoPaso {
    ...
    public static final Target ACEPTAR_TERMINOS =Target.the("Aceptar terminos").locatedBy("(//*[contains(.,'I have read and accept the')])[13]");
    public static final Target ACEPTAR_TERMINOS_DE_PRIVACIDAD =Target.the("Aceptar terminos de privacidad").locatedBy("(//*[contains(.,'I have read and accept the')])[14]");
